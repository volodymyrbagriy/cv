<?php
	...
	function pixelwars_core_meta_box__featured_media($post)
	{
		?>
			...
			<p class="howto pixelwars_core_featured_media__howto_post">
				<?php
			...
			<p class="howto pixelwars_core_featured_media__howto_portfolio">
				<?php
	...
	{
		add_meta_box(
			'pixelwars_core_add_meta_box__featured_video__post',
		...
		add_meta_box(
			'pixelwars_core_add_meta_box__featured_video__portfolio',
