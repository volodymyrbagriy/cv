			...
			<span class="entry-share">
				...
				<span class="entry-share-wrap">
					<span class="entry-share-inner-wrap">
						...
						<a class="share-pinterest" rel="nofollow" target="_blank" href="https://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?><?php if (has_post_thumbnail()) { echo '&media='; the_post_thumbnail_url('lahanna_image_size_1'); } ?>&description=<?php echo urlencode(the_title_attribute('echo=0')); ?>"><?php esc_html_e('Pinterest', 'pixelwars-core'); ?></a>
	...
	function pixelwars_core_share_links()
	{
		?>
			<div class="share-links">
				...
				<a class="share-pinterest" rel="nofollow" target="_blank" href="https://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?><?php if (has_post_thumbnail()) { echo '&media='; the_post_thumbnail_url('lahanna_image_size_1'); } ?>&description=<?php echo urlencode(the_title_attribute('echo=0')); ?>" title="<?php esc_attr_e('Pin It', 'pixelwars-core'); ?>">
